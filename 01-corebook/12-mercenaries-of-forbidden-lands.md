...
A mercenary band is a group of armed men who follow you because you pay them. Not because you saved their village. Not because a prophecy named you. Because you have silver, or the promise of it, and the road ahead looks like it might produce more.

This chapter gives you the rules to raise that band, feed it, pay it, march it into danger, and hold it together when the danger turns out to be worse than the contract described. It covers the economy of hired swords — what they cost, what they earn, and what happens when the coin runs out. It covers the individuals who matter inside the ranks — the Named Men who have opinions and the hired casters who have prices. It covers what the world does when your band crosses lines nobody wrote down but everyone remembers.
...
> _Gest called it a company. The Gristle called it a mess. Neither was wrong. Three dwarves, two Alderlanders with nothing behind them, a horseman from the Aslene steppe, a half-elf who smelled of bark and old blood, a thief whose name changed depending on who was asking, and a boy who washed his boots every morning like the world would end if they were dirty._
>
> _Twelve, with the captain. Twelve if you counted Ferrec, which Gest did, because the ledger counted everyone until the ledger stopped counting them. They had no banner. They had a name — the Gristle's band, which was not what she would have chosen but was what the men called it, and in the Ravenlands the name that sticks is the one other people give you._
>
> _She did not form this band. She inherited three men from a dead captain outside Weatherstone, hired two dwarves who were looking for work that did not require them to go underground, picked up the horseman at a crossroads inn, and accepted the half-elf's terms at a ford south of Ravenford because the alternative was turning down someone who could stop a man's bleeding with a word. The rest found the column the way stray dogs find a cook fire. Some of them were useful. All of them were hungry._
>
> _That was a band. That was how most of them started._

### Forming a Band

A mercenary band requires three things:
...
>
> Full Host mechanics — band-level tracking, the Warmaster's authority and alignment, and supply across multiple bands — are in the **Host Play** section at the end of this chapter.
...
**MORALE checks.** The leader rolls MANIPULATION vs. difficulty set by outstanding grievances (see Grievance Difficulty below). On a failure, the band loses one MORALE step. On 0 swords, two steps are lost and a Named Man may leave or act against the group.
...
| Paid on time, in full                            | +1 (once per season, does not stack per payment) |
...
| Atrocity ordered, men got plunder                | +1 (only when MORALE is 2 or below)              |
...
A band's origin shapes how it recruits, how it holds together, and what breaks it. These archetypes describe the most common formations in the Ravenlands. They are not mutually exclusive — a band may start as one type and drift into another.

**RURAL MOB.** Farmers, woodcutters, and hunters who ran out of land or watched it burn. They know the wilderness, they are unafraid of cold and hunger, and they have no illusions about what the work is. The core is usually a single village — men who grew up together, buried their dead together, and trust each other the way people trust what they have tested.

- **Recruitment:** +1 to finding men at rural settlements. The captain takes anyone from the home village who can hold a weapon and is willing. Strangers are considered on a longer timeline — they must eat with the men for several weeks and be vouched for by someone already in the band before they are treated as part of it. A new man who fits the crowd is accepted without ceremony. A new man who does not fit may never be trusted regardless of skill.
- **Strengths:** Treat one additional terrain type as favored when foraging. -1 to food cost when encamped in wilderness terrain. The band is **Trust-Held** by default.
- **Weakness:** If a contract takes the band far from their home region, MORALE checks are at +1 difficulty until the band has been abroad a full season. They also tend to carry the politics of the home village with them — old grudges, family debts, a face someone punched ten years ago.
...
**TYRANT BAND.** Built around one captain who holds the company by force and selective violence. The men stay because leaving has a cost and the alternative is starting over with nothing. Some of these companies are the most effective in the field. Some are charnel houses in slow motion.

- **Recruitment:** Prefers men who are already broken to something. Criminals, former convicts, men with debts or prices on their heads, men who have no settlement to return to. The initiation is a test of submission: new men are given the worst tasks, subjected to directed cruelty from the senior members, and watched to see if they break, run, or go quiet and adapt. Men who go quiet and adapt are the ones the captain wants. A criminal background is not required but is treated as a qualification: a man with a past is a man who cannot afford to leave.
- **Strengths:** May use INTIMIDATION in place of MANIPULATION on all internal discipline and MORALE checks. Common fighters do not check morale in the first round of any engagement — fear of the captain outweighs fear of the enemy.
- **Weakness:** The band is **Fear-Held** by default. Named Men Loyalty can drop to 0. When the captain is absent, removed, or visibly weakened, MORALE drops by 1 immediately and all Named Men re-evaluate their position.
...
**MILITARY SQUAD.** Veterans of a larger force: soldiers who served under a warchief, garrison troops left behind when the campaign ended. They drill, hold formation, and have a professional relationship to violence that peasant bands do not.

- **Recruitment:** Requires demonstrated prior service. A man who cannot name his role, maintain his own equipment, and perform a specific function in the line is turned away regardless of need. Roles must be filled — the captain recruits to gaps, not to headcount. Without a SCOUT, they recruit a scout. Without a MEDIC, they find a healer. When all roles are covered, they stop recruiting until something breaks. -1 to finding men at rural settlements. +1 at town-scale settlements and military encampments.
- **Strengths:** DRILL time is halved. Common fighters hold formation in the second round without a MORALE check. Sergeants in this band promote to full authority one engagement sooner than the standard rules require. Logistics are maintained precisely; the band never accidentally runs short through poor tracking. A military band that has maintained consistent pay for a full season becomes **Trust-Held**.
- **Weakness:** Pay expectations are higher and non-negotiable. A single late payment triggers a check at +1 difficulty. They also have opinions about the captain's decisions and will not hide them.
...
>
> That evening the Gristle pays the week's retainer: 2 silver per man for five common fighters — 10 silver. She has 80 silver incoming from the merchant when they arrive at Falcon's Ridge. The band ate well on the road — forest terrain, three foragers bringing back 8 FOOD per day, more than enough for ten mouths.
>
> After the first engagement with few casualties, MORALE rises from 3 to **4** — Steady. The men ate. They fought. They won. Nobody died. The coin is coming. The arithmetic works.
>
> The Gristle pays the merchant escort out at Falcon's Ridge. The band has 80 silver minus the week's retainer of 10 — 70 silver in the treasury. She buys three days of provisions at 10 copper per FOOD unit and starts looking for the next job. The band is five days old and already functioning.
>
> At the cookfire Gest tells Brosa to watch Petter's feet in the line next time, not the weapons. Brosa nods. He does not yet understand that this is kindness.
...
| Elf      | -2 to roll           | Rare as hired fighters. Those available are usually exiled, disgraced, or carrying something they can't name. When found, fight at Elite tier by default.                      |
...
When hired for field work away from the stronghold, fighters expect advance pay for the projected duration. Pay one week in advance. If the job runs long, pay again before the week expires or roll on the FIELD NON-PAYMENT table.
...
**Retainer** is what men earn when there is no work — traveling between contracts, waiting in camp, sitting in a town while the captain looks for the next job. It is a weekly sum, paid for the full week regardless of how many days the band idled. A man committed for five days is owed the full week's coin.

**Mission pay** is what men earn when the work begins — not when the band sets out, but when it starts doing the job. Marching to the contract site does not qualify. Mission pay starts when the band puts hands to real work and stops when that work ends. It is paid daily.
...
**Non-payment — retainer.** 14 days unpaid. The grievance accumulates slower on retainer, but it accumulates.
...
- A named enemy is killed
- The band discovers a cache the mission description did not list

| D6  | WINDFALL                                                                                                                                              |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1–2 | Nothing. The place was already stripped.                                                                                                              |
| 3   | Useful goods — equipment, tools, stores. Value: 15–40 silver equivalent. Not immediately liquid.                                                      |
| 4   | A war chest or merchant reserve in coin. Value: 50–120 silver. Distribute loot shares immediately.                                                    |
| 5   | A captive of value — a minor lord's relation, a merchant's factor, someone worth ransoming.                                                           |
...
When the band produces a material windfall — a bounty paid, tribute extracted, goods taken from a defeated enemy — that windfall is divided. It does not all go to the treasury.
...
**Tyrant:** The captain's word is law and his cut reflects it. Men serve because they have to or because the pay is still better than most. When the haul is lean, discontent rises fast — commons and veterans see the numbers.

**Standard Warband:** Rank exists. The leader earns more, Named Men earn more than grunts, but commons and veterans receive a larger share than a tyrant crew. The baseline for most mercenary captains.
...
> **Example — The Hungry March**
>
> The Gristle moves her warband of twelve out of forest cover and into hill country on day two of a clearing contract. She assigns four men to forage — 30% of her band strength, the contract-time maximum. The table returns 7 FOOD against a daily need of 12. The gap of 5 comes from the provision sacks.
>
...
When the leader fails to pay the band on time:

| D6  | EFFECT                                                                                                     |
| --- | ---------------------------------------------------------------------------------------------------------- |
| 1   | D3 of the unhappiest fighters desert overnight. They may sell information about the band.                  |
| 2   | A Named Man demands written acknowledgment of the debt. Refused: they leave.                               |
| 3   | The men keep working but slow down. Band counts as SHAKEN for the week.                                    |
| 4   | The sergeant confronts the leader publicly. MANIPULATION difficulty 2 to hold command. Failure: MORALE -1. |
| 5   | Quiet muttering only. The leader loses any +1 MORALE bonus this week.                                      |
| 6   | The men accept it for now. Every man remembers. Next non-payment rolls twice.                              |
...
Before demanding anything, compare the band's effective fighting strength to the settlement's available fighters — its guards, hunters, and men who will stand.

| SETTLEMENT SIZE          | APPROXIMATE FIGHTERS | NOTES                                                           |
| ------------------------ | -------------------- | --------------------------------------------------------------- |
| Hamlet, Farmstead (1–10) | 1–3                  | Almost no armed capacity. Will yield or flee.                   |
| Village (11–40)          | 2–6                  | A few hunters and one tough elder.                              |
| Large village (41–100)   | 5–12                 | Organized resistance possible.                                  |
| Town (101–300)           | 10–30                | A warchief or headman with real force. Requires a full Company. |
...
**MANIPULATION** treats the demand as one professional to another. A capable roll leaves the settlement poorer but not enraged.

**INTIMIDATION** skips the calculation and goes straight to fear. It carries three built-in costs:

- Standing drops 1 extra on any success
- Feud Track advances +1 on any success
- On a failed roll, the settlement does not merely refuse. Roll D6: 1–2, they draw weapons immediately; 3–6, they refuse and the band must escalate or leave
...
| Band previously extorted this settlement (same year) | +1                         |
| Settlement Standing already -3 or worse              | Roll fails automatically   |
...
**Repeat visits and depletion:**

| SETTLEMENT SIZE | ANNUAL TRIBUTE LIMIT | DEPLETION NOTE                                                      |
| --------------- | -------------------- | ------------------------------------------------------------------- |
| Hamlet          | 1                    | One round strips a hamlet bare.                                     |
...
- Counts as a SHELTER/BARRACKS equivalent for finding hirelings
- The band can draw on the settlement's HUNT/FORAGE output directly
...
- The settlement revolts: if Standing hits -5 and the detachment is fewer than required, the settlers attack at full settlement adult strength.
...
| 1    | Resentful    | Settlement talks to neighbors. Standing -1 at adjacent settlements.                   |
| 2    | Coordinating | Settlement seeks outside help. Warchiefs within 3 hexes may hear.                     |
| 3    | Armed        | Settlement has hired or allied with another force. They will seek eviction.           |
| 4    | Vengeance    | Settlement has committed to destroying the band regardless of cost. Area-wide bounty. |

At Feud Track 3 or 4, the opposing force becomes an active NPC faction. The GM names them, gives them a size tier, and they begin hunting the band. This is the machinery of consequence.
...
Public bounties and open patrol postings find the band on their own. Posted at inns, gate-keeps, and markets, they are available to anyone who asks. A MANIPULATION roll in a settlement of Reputation 3 or higher turns up current local postings. Three or more swords reaches regional postings.
...
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Band's Reputation is 4+                                                       | Automatic. They know who you are.                                   |
| Letter of introduction                                                        | No roll. The door opens on the introducer's Standing.               |
| Completed a contract for this employer before (Allegiance 1+)                 | No roll. The relationship already exists.                           |
| Demonstrated visible recent capability (cleared a hex, ended a threat nearby) | MANIPULATION difficulty 2 to convert that into an invitation.       |
| Cold approach, Reputation 3                                                   | MANIPULATION difficulty 3.                                          |
| Cold approach, Reputation 1–2, or OATH-BREAKER flag                           | MANIPULATION difficulty 4. Most employers decline without a reason. |
...
**Negotiating terms.** Once the audience exists, the leader makes a MANIPULATION roll to settle terms. The base difficulty is set by the employer's standing:
...
| CONTRACT TYPE              | PAY RANGE | DURATION  | PAYMENT TIMING               | NOTES                                                            |
| -------------------------- | --------- | --------- | ---------------------------- | ---------------------------------------------------------------- |
| **PATROL**                 |           |           |                              |                                                                  |
| Patrol (weekly)            | 110–165s  | 7 days    | In advance                   | Route or hex. Employer specifies the ground.                     |
| Patrol (extended)          | 200–300s  | 14 days   | Half advance, half on return | Harder terrain or wider circuit.                                 |
| Road clearance (long)      | 390–580s  | 21 days   | Weekly installments          | Multi-hex route security. Payment stops if band goes dark.       |
| **ESCORT**                 |           |           |                              |                                                                  |
| Escort (short)             | 80–140s   | 5 days    | On arrival                   | Person or cargo, single destination.                             |
| Escort (long haul)         | 200–320s  | 14 days   | On arrival                   | Multiple waypoints. Employer expects a report of each crossing.  |
| Bodyguard (personal)       | 175–280s  | 7 days    | In advance                   | One named principal. Band does not leave their side.             |
| Sensitive cargo delivery   | 160–260s  | 6 days    | On delivery, sealed chest    | No questions about contents. Liability clause standard issue.    |
| **CLEARING / ELIMINATION** |           |           |                              |                                                                  |
| Clearing (area)            | 160–260s  | 10 days   | On completion                | Remove a defined threat from a defined area.                     |
| Monster hunt               | 175–290s  | 8 days    | On proof of kill             | Named specific creature. No proof, no pay.                       |
| Bounty enforcement         | 100–200s  | 5–10 days | On delivery                  | Bring back a named individual alive or dead per terms.           |
| Sabotage / disruption      | 250–400s  | 10 days   | Half advance                 | Destroy enemy supply, cache, or command structure.               |
| **RAID / ASSAULT**         |           |           |                              |                                                                  |
| Warchief raid              | 225–380s  | 14 days   | Advance + half on return     | Open-field engagement or overrun operation.                      |
| Siege assault support      | 380–620s  | 10 days   | Half advance, half on fall   | Casualties expected.                                             |
| Punitive expedition        | 210–360s  | 10 days   | In advance                   | Make an example of a specific settlement or group.               |
| Ambush / interdiction      | 180–300s  | 7 days    | On confirmed disruption      | Set and hold a blocking force on a named route or crossing.      |
| Relief force               | 400–700s  | 14 days   | Half advance, half on relief | Break a besieged location. Employer pays double if it works.     |
| **GARRISON / DEFENSE**     |           |           |                              |                                                                  |
| Garrison (short)           | 340–500s  | 21 days   | Flat advance                 | Hold position. Band is present and ready; no external contracts. |
| Siege defense              | 350–550s  | 14 days   | In advance                   | Hold against incoming assault. Employer assumes breach risk.     |
| Settlement pacification    | 220–380s  | 14 days   | Weekly installments          | Occupy until population complies. Atrocity clause standard.      |
| Protection (season)        | 310–420s  | 91 days   | Advance + weekly             | Retainer pay only. Food on the band.                             |
| **INTELLIGENCE / SUPPORT** |           |           |                              |                                                                  |
| Scouting / recon           | 140–240s  | 6 days    | On report delivery           | Map and report a named area or enemy position.                   |
| Extraction / rescue        | 160–280s  | 7 days    | On safe return               | Bring a named person out of hostile territory alive.             |
| Hostile negotiation        | 150–250s  | 5 days    | In advance                   | Show of force for an employer's demand. Fighting is optional.    |
| Militia training cadre     | 280–420s  | 21 days   | Weekly installments          | Raise and drill local fighters to a service standard.            |
| **CASTER CONTRACTS**       |           |           |                              |                                                                  |
| Magical commission         | 280–420s  | 12 days   | In advance                   | Caster bands only. Employer specifies the working.               |
| Ritual ward                | 185–300s  | 8 days    | Flat advance                 | Caster bands only.                                               |
| Curse removal              | 200–350s  | 7 days    | On completion                | Caster bands only. Partial refund standard.                      |
| Divination mission         | 130–220s  | 5 days    | In advance                   | Caster bands only. Intelligence through magical means.           |
...
**Terms always specify:** target or task, duration, full amount and payment schedule, exclusivity, and liability for incidental damage.

**Breach.** If the leader breaks the contract, the employer can post a GRIEVANCE. A grievance becomes a Standing hit at every settlement the employer has Standing in. Repeated breaches accrue reputation as oath-breakers.
...
- A settlement or stronghold to anchor it
- The payment — coin, goods, or a combination — available upfront or guaranteed by a backer
- A description clear enough for someone to act on it

**Finding bounties:** Any PC making a MANIPULATION roll in a settlement of Reputation 3+ may ask about current bounties. One sword finds the local postings. Three swords turns up bounties from the broader region.

#### Bounty Types and Reference Prices

Silver is the Ravenlands' working currency. All prices below are floors. Below those floors, experienced collectors do not leave camp.

**Grievance bounties** arise from personal offense:

| OFFENSE                              | MINIMUM PRICE | NOTES                                                                                               |
| ------------------------------------ | ------------- | --------------------------------------------------------------------------------------------------- |
| Fled a small debt                    | 1–3 silver    | Usually posted to attach the debtor's name to a public notice rather than to recover coin.          |
| Theft of livestock or tools          | 2–5 silver    | Typically the stolen goods' value. Doubles when the thief is identified by name.                    |
| Desertion from a garrison or company | 2–5 silver    | Rarely spreads past two hexes — it signals internal problems.                                       |
| Assault resulting in lasting injury  | 3–8 silver    | Scales with injury: a cracked rib is 3, a severed finger is 8.                                      |
| Fled a serious debt                  | 8–20 silver   | Climbs if the debtor is heard to be doing well somewhere else.                                      |
| Murder of a commoner                 | 5–15 silver   | Higher when the dead had family with resources.                                                     |
| Arson                                | 8–20 silver   | Often pooled when a single fire touched more than one household.                                    |
| Murder of a community figure         | 10–25 silver  | The settlement posts it as a body, not as a family. An elder commits the settlement's formal funds. |

**Professional breach bounties:**

| BREACH                                                 | MINIMUM PRICE        | NOTES                                                                                             |
| ------------------------------------------------------ | -------------------- | ------------------------------------------------------------------------------------------------- |
| Abandoned a contract after taking advance pay          | Advance paid + 50%   | The advance plus the cost of the signal.                                                          |
| Sold intelligence to an opposing party                 | 10–30 silver         | Reflects how much damage the leak caused.                                                         |
| Escort who abandoned cargo or left the employer to die | Equal to cargo value | If the employer survived, the posting is the insult's price.                                      |
| Named Man who turned on their own company              | 10–30 silver         | A low number says the man was not much to begin with. A high number says the captain wants blood. |
| Captain who delivered a false-strength company         | 5–15 silver          | Posted more for the story it tells than the money it might recover.                               |

**Elimination bounties:**

| TARGET                                     | MINIMUM PRICE | NOTES                                                                                                    |
| ------------------------------------------ | ------------- | -------------------------------------------------------------------------------------------------------- |
| A known bandit on a specific road          | 3–8 silver    | Multiple merchants may pool the posting.                                                                 |
| A Named Man responsible for an attack      | 8–20 silver   | Rises when the survivors' families add to a standing pool.                                               |
| A company captain who terrorized a village | 15–40 silver  | May run partially to goods when coin runs out.                                                           |
| A captain responsible for an atrocity      | 20–75 silver  | Regional posting, backed by multiple affected settlements.                                               |
| A warchief's named direct enemy            | 50–200 silver | Always comes with political strings: the poster has a side, and delivery implicates the collector in it. |

**Recovery bounties** attach to stolen or missing objects rather than persons:
...
| Merchant goods, tools, or locked strongbox      | Equal to the contents       | A stated estimate that proves incorrect at delivery generates a new grievance. |
| Land deed, contract, or legal document          | 5–25 silver                 | The value is what the document controls.                                       |
...
- Outlast it — a bounty not pursued for a full year fades from active memory; reduce its effective spread by 1 step each season after the first
...
_Transfer requires presence._ Unlike coin at an inn, a house, a boat, or a grain store cannot be transferred from a distance. The collector must physically appear at the collection point. A poster who wants serious hunters puts the goods close to where the killing is, or adds a coin supplement for the march.

_The poster must hold clear title._ A settlement elder who offers the communal grain store needs the settlement's agreement — not signature, agreement. Before accepting goods payment, ask plainly: _whose goods are these, and who vouches for it?_ A public announcement before the council, a written agreement, or a named third-party guarantor are all acceptable answers. The absence of all three is a warning.

_Goods spoil, break, and die._ A horse sound at posting may be lame at collection. A grain store posted in autumn may be half-eaten by spring. A collector who wants protection negotiates a condition clause at acceptance: goods delivered must match goods described at posting, or a silver supplement covers the difference.

**Third-party guarantors.** Any goods payment above 15 silver equivalent requires a guarantor to attract professional interest. A guarantor is a trusted third party who witnesses the posting and can testify in any dispute about whether the delivery satisfied the terms. Common guarantors: settlement elders, innkeepers of established standing, priests of any recognized faith, captains of unrelated bands. A guarantor who vouches falsely damages their own standing. This is usually enough.
...
**As a contract:** An employer pays to have a specific person captured and delivered alive. Terms always specify condition: alive means breathing and able to stand and answer questions. A dead or permanently broken delivery earns partial payment at best.

**As a ransom operation:** The band captures someone worth money to someone — a merchant's son, a warchief's wife, a named creditor — and holds them while sending word. The value of the ransom depends on who was taken and what they mean to the payer.
...
- A captive who is starved, tortured, or treated as a slave rather than a prisoner arrives at delivery in a state the employer or family may find unacceptable.

A captive who dies through negligence triggers a reduced consequence: Standing at the relevant settlement drops by 1. The full Atrocity cascade does not apply unless the negligence was sustained and witnessed.

**Ransom negotiation:** Send word first. State the amount, the delivery point, and the deadline. The GM determines whether the target's connections can pay.
...
**Recovery bounties:** Anyone with coin and a kidnapped person they want back can post a bounty for the captive's safe return. Recovery bounties always specify condition — alive, unharmed, or alive and able to testify. Dead delivery is worth nothing. A recovery bounty travels through the rumor system like any other bounty — and creates competition that puts the kidnapping band in a difficult position.
...
**Establishing a hoard.** Choose a hex and a specific terrain feature — a hollow root, a marked stone, a particular river bend with a distinctive fork. Make a SURVIVAL roll. Each sword indicates how difficult the cache is to find by someone who does not know the exact location:

| Swords | CONCEALMENT                                                                   | HOARD LEVEL | FINDER'S DIFFICULTY |
| ------ | ----------------------------------------------------------------------------- | ----------- | ------------------- |
...
The leader records the hoard's **marker**: the exact hex and a specific terrain feature. The marker is private. If the leader dies or deserts without disclosing it, the hoard is lost as a practical matter — though it stays in the ground.
...
**If the marker's landmark has changed** — the tree was struck by lightning, the boulder was quarried away, the streambed shifted after a flood — the marker no longer leads directly to the cache. Make one SCOUTING roll at the hoard's full difficulty. This is not the grinding multi-roll blind search, but one hard roll, answered in a Quarter Day.

The GM determines whether the landmark is intact, damaged (marker still functions), or gone (marker fails, one difficulty roll applies).

The band that finds the hoard owns it. There is no inheritance in the Ravenlands.

What a dead band's hoard contains is up to the GM. Some captains buried coin and weapons. Some buried things they wanted no one to trace back to them — goods that explain a massacre, documents that implicate a warchief, a bound and preserved head. Sometimes the hoard explains why the band died.

> **Example — Petter's Hoard**
>
...
A Skirmisher band needs no dedicated logistics Quarter Day. A Warband needs one per day. A Company needs two unless a STEWARD or senior sergeant handles them, reducing it to one.
...
All Named Men begin with their tier's MELEE. **Veteran 2, Elite 3.** Not optional. This is why they are worth naming.

**Additional skills from the Field Skills Pool:**
...
- **Veteran:** 4 from pool; at least 2 at rank 2; the rest at rank 1 or 2
- **Elite:** 6 from pool; at least 4 at rank 2 or higher; at least 1 at rank 3
...
Named Men know armor is survival. A man who has lasted three seasons will have traded coin for better iron and will not go into a fight bare-headed. Veterans are expected to carry at minimum an open helmet alongside their body armor. Elites with the coin and access upgrade: a Named Man who steps forward in half-plate is noticed, and one in full plate is remembered. The GM may limit the heaviest armor by band prosperity or supply, but the Named Men's default inclination is always upward.
...
Non-player Named Men recover 1 WP per day of downtime. If a Named Man transitions to a player character, use normal PC recovery rules.
...
Armor: Chainmail (4), Open Helmet | Weapon: Sword + shield
...
Armor: Studded Leather (3), Open Helmet | Weapon: Crossbow + short sword
Trigger: Ordered to harm civilians
Agenda: A private enemy they want dead
...
Armor: Chainmail (4), Open Helmet | Weapon: Great axe
Trigger: Consistently spoken of as beneath notice
...
Armor: Chainmail (4), Closed Helmet | Weapon: War axe + shield
Trigger: Not elevated when clearly more capable
Agenda: Respect — to be seen as the kind of man others follow
...
Three tiers of hired caster, differing in raw ability, spell rank access, and the number of disciplines studied. Willpower is the measure of how much work they can do before they must rest.
...
- **Initiate:** 3 from pool; at least 2 at rank 2. Roughly equivalent to 40 XP of advancement above a freshly created character.
- **Adept:** 5 from pool; at least 3 at rank 2, at least 1 at rank 3. Roughly equivalent to 100 XP of advancement above a freshly created character.
- **Master:** 8 from pool; at least 6 at rank 3, rest at rank 2. Roughly equivalent to 180 XP of advancement above a freshly created character, accounting for dual-path talent investment.
...
> **Example — The Caster's Cost**
>
> Ash is an Adept with Healing discipline and 3 WP. The morning fight at the river crossing leaves two men down — Brosa with a smashed shoulder and a common fighter with a gut wound that will not close on its own.
>
> Ash spends 2 WP on **Healing Hands** — Brosa first, because the Gristle pointed at him. The shoulder mends. Brosa can hold a sword again by evening. The common fighter gets the remaining 1 WP. It is not enough for **Mend Wounds** (rank 2, costs 2 WP). She pushes it — spending that last point and risking the mishap table.
>
...
When a member of the band becomes wanted, the bounty amount determines how far the news travels:
...
| Burning          | Destroying a settlement's means of survival                                |
| Ransom killing   | Executing a captive accepted for ransom or who surrendered expecting mercy |
| Slave-taking     | Taking free people by force                                                |
| Breaking an oath | Violating a sworn agreement before witnesses                               |
| Treachery        | Killing an ally, turning on an employer, betraying inside knowledge        |

### Consequences

1. **Standing crash.** Every settlement within rumor range loses 2 Standing with the band, or drops to -3 if they were allies. Settlements with direct survivors drop to -4 or -5.
2. **Reputation spread.** The act travels as recognized fact, not hearsay. This does not require a roll — it happens.
...
## New Stronghold Function: War Room
...
## Serving in Another's Company

> _The Gristle did not always lead. Before she was the Gristle — before anyone called her that — she was a blade in a company run by a man called Torsten the Long, who was neither long nor short but carried a polearm he could not explain and who ran a warband of twenty-two with the specific combination of competence and silence that made men follow without being told why._
>
...
The mode works best as a bridge. Three or four sessions under another captain's orders gives scope for a richer transition to leading a band of their own. It also builds history: the fellowship will know what a working company looks like, what breaks one, and who they actually want to keep.

### Terms of Service

A company takes on new men at the captain's discretion. If the captain is selective, the GM may call for a MANIPULATION roll (difficulty 1–2) before terms are offered.

Signing terms:

- **Daily wage** (see rank table below)
- **Duration:** season, named contract, or open-ended
- **Exclusivity:** the company's contracts take priority while the term runs
- **Standing orders** — these predate the fellowship and apply from the first day

**Standing Orders** — every company has rules that settled before you arrived. Roll D6 or choose:
...
The fellowship is subject to standing orders immediately. Breaking one is not grounds for punishment the first time. The captain notes it. The second time, the sergeant speaks directly.

### Rank

| RANK        | ENTRY CONDITION                                                 | PAY/DAY  | AUTHORITY                                                                             |
| ----------- | --------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------- |
...
>
> Give the captain one thing they want that is not the contract. A debt they are working down. A person inside the company they are protecting. A war they are steering quietly around. When the fellowship discovers what that is, the entire relationship changes.
>
...
>
> You are not in charge. You carry your gear, eat what the cook makes, and sleep where the sergeant indicates. That is not a limitation on the session, but the opening condition of a different kind of play.
>
> The game is in the people. You have time to learn who is in this company — the sergeant who gives harsh assignments because it is the only way to keep fresh men alive, the First Blade who says less than anyone and moves decisions in ways you cannot track until you have been here long enough. Push into that web. Ask the wrong questions. Make small alliances before you understand why they matter.
>
> Rank is satisfying to earn here precisely because no one gives it to you. You do the thing, someone witnesses it, and later the sergeant states your new rank the way they would state a weather condition — flat, permanent, done.

### Disagreeing with Orders

The captain gives orders. The fellowship may find those orders wrong, dangerous, against what they will do.

- **Comply** — no roll. Whatever follows is the company's consequence and the fellowship shares it.
- **Object** — MANIPULATION difficulty 1. On success, the captain listens and explains their reasoning; they may not change the order, but they will not hold the objection against the fellowship. On failure, the captain notes it. Two failed objections earns a warning.
...
Departing mid-contract is breach. The captain's Standing at nearby settlements determines how far the grievance travels.
...
2. A witnessed triggering event: an atrocity, a catastrophic failure, a clear oath-break
3. A MANIPULATION roll by the senior mutineer at difficulty 3, opposed by the captain's own roll
...
Each band is tracked separately — its own roster, MORALE score, Named Men, and daily cost. The PCs' band uses the full mechanics. Other bands exist at summary level: the GM tracks their strength die, current MORALE, and standing obligations. Their captains are supporting NPCs.

### The Warmaster's Authority

A Warmaster gives operational orders. Band captains follow them — or do not. The chain of authority runs on reputation, past payment, and the belief that the Warmaster can deliver what was promised.
...
A Warmaster is either independent — running the Host as their own enterprise — or sworn to a faction.

An **independent Warmaster** negotiates contracts the same way a band captain does. If the contract falls through, the Warmaster absorbs the loss or passes it down. If they pass it down, every band's MORALE is at risk simultaneously.

A **faction Warmaster** represents an employer with institutional backing — a warchief's army, a noble's levies, a trade guild's private force. The faction supplies, funds, and controls the strategic objective. The Warmaster executes it. What the faction wants and what the Warmaster tells the captains may not be the same thing; the gap between them is where political pressure operates.

A band serving under a faction Warmaster is treated as Allegiance 1 toward that faction by default. If the Host achieves the campaign objective, the band gains Allegiance +1. If the Host fails badly, the faction may redirect blame — and a named band makes an easier target than a dispersed force.
...
The Warmaster holds the Host's coin — not as a personal fund, but as a working account the entire force runs on. Every contract payment, every advance from a faction employer, flows into the treasury first.
...
The GM holds the treasury total. The PCs either manage it (if they are the Warmaster) or observe its effects (if they are a band captain). A captain asking about pay security makes a MANIPULATION roll at difficulty 1 to get a straight answer.
...
| DISTANCE   | CLEAR ROAD | DIFFICULT TERRAIN | WINTER       |
| ---------- | ---------- | ----------------- | ------------ |
...
**Standing orders:** Every band operates under standing orders — what to do if contact is lost, what threshold justifies independent action, how long to wait before assuming the Warmaster's situation has changed. Standing orders cover at minimum: withdrawal threshold (when to pull back without orders), contact protocol (how to signal the Warmaster's relay point), and emergency action authority (what the band captain may decide alone).
...
A Host deals with parties the individual bands cannot. A faction that will not meet a single captain will meet a Warmaster.
...
| Regional     | 2          | Warchief with a territory, guild with several towns          |
| Major        | 3          | A lord with military force, a large faction with standing    |
| Great        | 4          | A power that controls borders, a warlord with multiple Hosts |
...
**Rival Host parley:** Two Hosts that could fight are often better served talking. A Warmaster who wants to parley sends a rider under flag of truce. The rival may accept or refuse. Refusing is not an atrocity. Executing the rider under truce is.
...
**Third-party arbitration:** Disputes between Hosts, broken truces, or contested claims over a contract payment may be submitted to a third-party arbitrator both Warmasters recognize. Common arbitrators: priests of standing, prominent merchants, elders of a sufficiently neutral settlement, the patron faction of one Host if the other accepts their authority. The arbitrator's ruling is not enforceable by law — the Ravenlands has no court — but enforced by the same mechanism all Host obligations run on: REPUTATION damage to the party that defies it. Both Warmasters agree before arbitration begins that defying the ruling removes their right to dispute the other's response. That agreement is what gives arbitration teeth.

> **If the Host has a caster:** COMPEL TRUTH during arbitration testimony is considered legitimate under Ravenlands custom. Tongues eliminates the interpreter gap. Telepathy reading a rival's surface thoughts during parley is effective and detectable — Sense Magic is automatic.
...
| RIVALRY | EFFECT                                                                      |
| ------- | --------------------------------------------------------------------------- |
| 1       | Captains are cold. MANIPULATION between them at +1 difficulty.              |
| 2       | Men are hostile. One random Minor Offense incident per week in shared camp. |
| 3       | Joint operations require MANIPULATION difficulty 2 from both captains.      |

**Reducing Rivalry:** The Warmaster may spend one council action and REPUTATION 1 to formally broker a ceasefire between two rival bands. This drops Rivalry by 1. The alternative is letting it run — which teaches the Warmaster something about their own command, because Rivalry 3 between two of your bands means you created a condition and ignored it long enough for it to get there.
...
Track separately from personal REPUTATION. Runs from -6 to +6, starts at 0.

**The Ledger rises (+1 per event):**

- Contract completed and all bands paid on schedule
- A battle won with low band casualties
- A faction negotiation that improved conditions for two or more bands
- The Warmaster absorbs a personal loss to protect band pay
...
- Band casualties caused by a disputed Warmaster order
- A failed negotiation that put the Host in a worse position
- A rider lost and an operation that failed because of it
- A council vote overridden without later justification

| LEDGER   | EFFECT                                                                                                                                             |
| -------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| +4 to +6 | Authority calls require no MANIPULATION — captains follow without rolls.                                                                           |
| +1 to +3 | Standard authority.                                                                                                                                |
| 0        | Neutral.                                                                                                                                           |
| -1 to -3 | Every order requires MANIPULATION at +1 difficulty.                                                                                                |
| -4 to -6 | Host is fracturing. Any captain with REPUTATION 2+ may call emergency council without co-signers. The Warmaster's two council votes reduce to one. |
...
- **A carved horn cup**, set on a flat stone just inside the ruin when Hadric first used the cache site — left by whoever was here before, he assumed. Functional, no decoration except a banded pattern cut into the rim. He has drunk from it three times, each time while working through a decision he was not ready to make in front of anyone. He considers the ruin a good place to think. He has not taken the cup away from it.
...
> **GM — THE CARVED HORN CUP:** When a person speaks an explicit decision aloud while holding or drinking from this vessel, that declaration is registered by the cup as a binding commitment. It was a deliberation instrument of the old order — used when its councils needed resolutions to carry weight past the leaving of the room. It does not compel action directly and leaves no visible mark. It tilts circumstance: in the weeks after a spoken declaration, unrelated events begin arranging themselves toward the declared outcome, incrementally, in ways that look from inside them exactly like competence and momentum gathering. Hadric has drunk from it three times. The first time he resolved privately to press the second tribute from Feldwick regardless of the company's condition. The second time he spoke aloud that the northeast tributary circuit would be held and the warchief would have his meeting before the spring thaw. The third time he told himself, after reading a delayed letter, that the plan was already running and would run without him if necessary. All three declarations are now active. The warchief's correspondence has grown urgent in ways neither party anticipated. Feldwick is accelerating toward confrontation faster than Hadric planned. The third declaration may be the most consequential: the cup is now working to make it true that this plan runs without him if necessary.
...
- **The treasury documents** — six sheets of densely ciphered text, taken from a contract two seasons ago and never returned to the employer. The employer has since died, which the captain considers closure on the contract but not the question of what the documents say. Five sheets decode cleanly against the merchant house cipher. The sixth does not. He has logged it as a corrupted copy or a different key entirely and set it aside. It is smaller than the others, older, and the notation style is unlike the other five in ways he has not had time to characterize.
...
> **GM — THE SIXTH DOCUMENT:** The sixth sheet is not a merchant cipher and is not from the same era as the other five. It predates the Blood Mist by at least three centuries and is written in the architectural notation of the old order's binding engineers — the system used to specify the construction of containment structures for things the old order could not kill. It is the complete original specification for the anchor site east of Vond: what the site holds, what the binding was built to constrain, the structural principles that make the containment work, and the precise sequence of manipulations that would dissolve it permanently. Vael has spent ten years approaching this question from fragmentary secondary sources. She has been working, in her terms, on verifying that a binding holds. The document the captain has logged as a minor encoding problem is the original master specification for the exact thing she has been hunting — including the answer to the question she has not admitted she is also asking: how the binding comes undone. If she reads it, both questions become answerable. The captain has it in the same oilcloth bundle as the other five sheets. He will return to it when he has time.
...
- **A brass compass in a worn leather case** — the instrument the advance scouts were carrying on the morning the campaign's first engagement went wrong. The needle does not point north. Has not since that morning. Coldhand catalogued it as instrument damage in the first week, kept it anyway, and stopped cataloguing it after that. He has pulled it out twice in the last month and looked at the needle and put it away without deciding anything. He does not know why he checks it.

SURVIVAL difficulty 2 for the company chest's location when stationary; difficulty 3 for the personal cache.

> **GM — THE BRASS COMPASS:** The needle points toward the nearest active pre-Blood-Mist binding anchor within the region — not magnetic north, not any fixed bearing, but the nearest place in the world where something has been sealed by the old order's working. The bearing shifts slowly as the company moves and as the sites themselves change state. It currently points east-northeast. The scouts who walked out of position on the morning the campaign ended were not informants. They were following the compass bearing without understanding what it meant. The original holder did not understand it either. The instrument has passed through six hands. None of them knew what they were carrying. For a captain who begins deliberately reading its bearing: every sealed site in the Ravenlands becomes findable. Every bound thing. Every contained catastrophe the old order left behind when the Mist came down. Every ward, every cache, every prison the old order built and did not have time to empty or explain. Coldhand has been adjusting patrol routes toward its current bearing for two seasons without noticing. The Nail's theory about the campaign betrayal may not be entirely correct.
