...
| Allec  | Common  | 3   | 3   | 1     | 3     | Left a lord's garrison. Won't say why. Suspects someone is still looking for him.                                      |
...
Midway through a month-long patrol contract with the village of Ashmill — keeping the trade road clear of a wolf pack and the remnant of a bandit group that broke up in winter. Three weeks in, one bandit engagement, no losses. Pay arrives weekly; current week paid in full. MORALE is steady.
...
**Posted by the company:** 4 silver on Gruv the One-Armed. Posted at Ashmill and at a large village two hexes west. Description specific: a one-armed orc war-shaman with a burned right shoulder.
...
Four families walked away from a village whose well went slow in the second year and stopped entirely in the third. They picked up one fighter at a crossroads inn, lost him, picked up two more from a burned farmstead, and arrived at their current size by attrition and chance rather than design. Brek named them after himself, which the others accept because Brek is the one who gets the contracts and the others have no better alternative to offer.
...
| Iker  | Common | 3   | 4   | 1     | 3     | Young, fast. Thinks this is temporary. The others think so too, for different reasons.                                        |
...
Three days into a pest clearance contract — two trolls reported in a marsh hex east of a small village. The village offered five silver on confirmation of the kills. The company is in the marsh. The troll count appears to be three, not two. Nobody has said this out loud yet but Lenna is going to say it.
...
**Ironback Company** — saw them at a roadside camp once, three months ago. No formal introduction. The Ironback Company looked at the Rovers with the particular professional assessment that well-drilled soldiers apply to men who aren't, and said nothing. Brek noticed.
...
The company is three weeks into occupying a large village called Feldwick. It is the second time they have demanded tribute from Feldwick this year. The elder is already past desperate. His neighbors know it. Feud Track at Feldwick: 2.
...
| Parn             | Common  | 3   | 3   | 1     | 3     | Ravenish not his first language. Follows orders extremely well. Nobody asks where he is from.                                       |
...
**On the company:** 15 silver on Hadric the Younger personally, posted at a town four hexes east by a merchant factor whose grain wagon the company burned during a job that went over scope six months ago. Spread: regional. Other mercenaries in the region have heard of it.
...
**Ironback Company** — professional contempt (from Ironback toward Three Wolves). The Ironback Company considers them an embarrassment to the trade and a source of civilian backlash that makes everyone's contracts harder to negotiate. No direct contact. The feeling is regional reputation only.
...
| Orveck | Common  | 3   | 3   | 1     | 3     | No traceable past before the company. Connected to nothing. The captain considers this an asset.                                                               |
...
## THE IRONBACK COMPANY

**Archetype:** Military
**Size:** Warband — 18 men (4 Named Men + 14)
**MORALE:** 4 — Steady
**Known as:** _The Ironback men. Hold when others don't._

The Ironback Company is the garrison that kept its formation after the fort was abandoned. They held for two years while the warchief who raised the fort redirected his resources elsewhere, and by the time the holding became impossible, holding was all they knew. Seld Marten walked them south, got them paid for a job that needed doing, and has been doing this ever since. They are not the biggest company in the region and they know it. They are, within their size tier, among the most reliable — which is the kind of reputation that generates steady work.

They drill, they hold formation, they pay attention to logistics. The men who couldn't do those things left quietly in the first year. What remains is functional.

---

### Named Men

**Seld "Ironback" Marten** — Captain, Elite, Line
The name came from a blade left in his back during the second winter of the holding — he kept his position for four hours with it there, because the position needed holding and no one else was holding it. He does not think of this as remarkable. It is what the work required. He is a straightforward man in most respects, which makes one thing stand out: the man who abandoned the fort is still alive, and Seld has not yet presented him with an accounting. The company does not discuss this openly. They know it is where things are eventually going.
...
**Trigger:** Being asked to abandon the formation's standards and act as a looter or irregular
**Agenda:** Find the warchief who abandoned the fort and present him with an accounting for the lives spent in those two years
**Loyalty:** N/A (captain)
**Personality:** Mercenary Proud.

---

**Yona "Pale-Eye"** — Sergeant, Veteran, Skirmisher
One grey eye, one brown. She leads from the scout position rather than the center of the line, which is unorthodox but has worked consistently. She is specific about credit — she will not accept it for decisions that were Seld's, and she will not assign it to Seld for things that were hers. This is not ego; she has specific reasons for needing a clean record, and attribution matters for that purpose.

| STR | AGL | WIT | EMP |
| --- | --- | --- | --- |
| 3   | 4   | 4   | 2   |

**Skills:** MELEE 2, MARKSMANSHIP 1, SCOUTING 1, STEALTH 1
**Talents:** FAST SHOOTER rank 1
**Armor:** Leather (3) | **Weapon:** Shortbow + short sword
**Trigger:** Being given credit for a decision that was actually the captain's — or denied credit for one that was hers
**Agenda:** Build a record clean enough to return to a specific settlement and look at the person who drove her out without them having legal grounds to act
**Loyalty:** 3
**Personality:** Territorial. Her work, her line, her attribution.

---

**Torvin "the Teacher"** — First Blade, Elite, Line
He explains things while doing them, mid-fight, which should be irritating and is occasionally infuriating and is also, over time, how the company learns. He has been training a succession candidate in every company he has served in. He has not fully succeeded in three previous companies. Bressan is the current project. He has not told Bressan this explicitly. Bressan has figured it out anyway, which Torvin considers a passing grade on a prerequisite.

| STR | AGL | WIT | EMP |
| --- | --- | --- | --- |
| 5   | 3   | 3   | 3   |

**Skills:** MELEE 3, MANIPULATION 1, ENDURANCE 1, MIGHT 1
**Talents:** SWORD FIGHTER rank 3, COMBAT EXPERIENCED rank 1
**Armor:** Chainmail (4) | **Weapon:** Sword + shield
**Trigger:** Watching capacity go deliberately wasted — a person who could learn and refuses to
**Agenda:** Train one person in each company well enough to replace him; this is the fourth attempt
**Loyalty:** 3
**Personality:** Mercenary Proud.

---

**Arven** — Veteran, Support
There is a particular quality to medics who have been with a fighting company long enough: they know exactly how much damage a person can absorb and still be retrieved, and they have a sense of humor about it that other people find alarming. Arven's sense of humor is dry enough to pass as silence unless you know what you're listening for. He is the company's least assuming Named Man and its most critical resource. Seld knows this. Arven does not let Seld forget it.

| STR | AGL | WIT | EMP |
| --- | --- | --- | --- |
| 3   | 3   | 3   | 4   |

**Skills:** MELEE 2, HEALING 2, INSIGHT 1
**Talents:** PAIN RESISTANT rank 1
**Armor:** Leather (3) | **Weapon:** Short sword + medical tools
**Trigger:** Being left without the materials to do the work when someone is dying
**Agenda:** Access a specific monastery's medical archive — there is a remedy in it for something he has not explained to anyone
**Loyalty:** 2. Will leave before the company runs low enough that his work stops making sense.
**Personality:** Dark Amused. About everything except the healing.
...
| NAME    | TIER    | STR | AGL | MELEE | ARMOR | NOTE                                                                                                                                                          |
| ------- | ------- | --- | --- | ----- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Bressan | Veteran | 4   | 3   | 2     | 4     | Has held the line in eleven engagements. Stopped being surprised by blood a long time ago. Torvin's project.                                                  |
| Cord    | Common  | 3   | 3   | 1     | 3     | Young, eager, and precisely the kind of person the Teacher has taken on as a second-tier project.                                                             |
| Halve   | Veteran | 4   | 3   | 2     | 4     | Quiet competence. Does not volunteer for anything; completes everything assigned without complaint or error.                                                  |
| Mik     | Common  | 3   | 3   | 1     | 3     | A soldier's son who grew up on the garrison road. Knows the forms without having done the work yet.                                                           |
| Oss     | Common  | 3   | 4   | 1     | 3     | The company's best forager. Arven taught him to identify fever-bark in the field; he has since expanded this considerably.                                    |
| Drenn   | Veteran | 4   | 3   | 2     | 4     | Former sergeant, demoted after an incident the company does not discuss in front of new men. Still carries the rank posture; no longer carries the authority. |
| Sable   | Common  | 3   | 3   | 1     | 3     | Nervous under direct fire, reliable in positions where he cannot see the source of threat. Bressan pairs with him for this reason.                            |
| Wold    | Veteran | 4   | 3   | 2     | 4     | Former engineer. Builds fortifications faster than anyone here. Seld uses this; Wold treats it as a fair exchange.                                            |
| Fennel  | Common  | 3   | 3   | 1     | 3     | Named for a plant he chews constantly. Cannot explain why, just cannot stop.                                                                                  |
| Overn   | Common  | 3   | 3   | 1     | 3     | From a large village three hexes south that the company has been avoiding. Overn hasn't explained what's there. Yona hasn't pressed it.                       |
| Tolt    | Common  | 3   | 3   | 1     | 3     | Brand new to the company. Still learning who is who. Oss is explaining the pecking order to him incorrectly, for entertainment.                               |
| Garen   | Veteran | 4   | 3   | 2     | 4     | Was in a company that dissolved after a bad contract. Has not attached himself to this one emotionally. Seld has noticed.                                     |
| Pelv    | Common  | 3   | 3   | 1     | 3     | Excellent with horses. The company has four. He is also the youngest person anyone would permit near them.                                                    |
| Skeld   | Common  | 3   | 3   | 1     | 3     | No relation to the captain. Introduced himself saying "not the captain." It became the joke the company milks. He has accepted his fate.                      |

---

### Current Status

Three weeks into a three-hex patrol contract, hired by a trade consortium to keep a specific road section clear of a known bandit group. Two weeks remaining. On track. Current patrol position: hex 2 of 3. MORALE is Steady. The contract is straightforward and the pay is arriving.

Drenn has been sending messages. Seld does not know the recipient.

---

### Bounties

**On Yona:** 9 silver posted at a settlement four hexes northeast, a year ago. The band has not returned to that settlement. The bounty has not been renewed but is still technically active.
...
**Three Wolves** — professional contempt. The Two companies operate in the same general region. The Ironback Company considers them a liability to the trade's reputation. No direct engagement. The disdain is communicated through posture and rumor.

**Saltmarch Rovers** — occasional commercial exchange. The Rovers forage surplus that the Ironback Company sometimes buys. The transaction is efficient and neither side has any particular opinion about the other beyond that.

**Cold Company** — mutual respect at a distance. Have never shared a contract area. Both captains have heard the other's name from credible sources and think well of it. If they operated in the same region, they would probably work well together. They have not yet tested this.
...
Seld keeps the company finances in a locked strongbox in the supply wagon. He considers hidden funds a sign of a dishonest captain and he does not hide them. The company knows the count. It is accurate.

**Company treasury — the wagon box:**

- **95 silver** in wages-held, five weeks of the current company's full payroll
- **28 silver** operational reserve for provisions, equipment repair, and contingency
- **A signed copy of the current consortium contract**, dated and witnessed
- **A leather pay ledger** recording every man's wages owed and paid for the past three seasons. Drenn is listed by rank; the entry before his demotion is crossed out in a single line with no annotation.

The box has one key. Seld carries it.

**Seld's personal — no coin, two documents:**

In a sealed wooden scroll case in his personal pack:

- **The citation of garrison service** from the holding — stamped with the abandoning warchief's seal, countersigned by two garrison officers who are still alive and remember what they signed. Proof that the company held, proof that it was abandoned, proof that the warchief's seal authorizes the obligation Seld intends to present.
- **The accounting** — a second document in Seld's handwriting, updated over two years. Names of the dead, the date each died, the position they held when they died, and one sentence about each. The final line reads: _twenty-two men held for twenty-two months. We were not relieved._

Seld does not call this a hoard. Both documents are folded inside a leather cover Torvin made him as a field gift two years ago and has never mentioned since. Nobody knows Seld has the accounting. Torvin suspects it.

---

### Internal Tensions

Torvin has been quietly bringing Bressan up as a potential Named Man and eventual First Blade replacement. Seld has noticed the teacher–candidate dynamic and has not addressed it, because he does not know whether Torvin is building a successor or building a faction. Torvin is building a successor. Seld's caution is understandable and Torvin would not hold it against him if it were raised directly. It has not been raised directly.

Drenn, the demoted sergeant, has established contact with the warchief who abandoned the fort. His intention is to arrange a compensation settlement that would resolve Seld's long-standing objective and allow the company to move forward without the accounting waiting in the background. He is doing this without Seld's knowledge and has made preliminary commitments that Seld would reject if asked.

---

### GM Hook

The warchief who abandoned the fort has sent an emissary toward the company's current patrol hex. The emissary is not carrying an offer — they are carrying a warning. Something the warchief believes Seld needs to know before Seld finds him. Drenn knows the emissary is coming. He has not told Seld. He is hoping to intercept the message, assess it, and present a cleaned version that makes the compensation idea look better than it currently does.
...
| Deff  | Common  | 3   | 3   | 1     | 3     | A smith who left his town for reasons he doesn't discuss. Keeps equipment better than anyone else here.                                            |
...
**On the whole company:** 12 silver, posted at a settlement two hexes south. Two months ago the company acquired provisions under duress while in a difficult supply position. The settlement considers this a robbery. The company considers it an emergency requisition. The distinction is not legally meaningful in the Ravenlands, but the 12 silver is real.
...
**Ironback Company** — mutual respect at a distance. Never shared a contract area. Both captains have heard each other's names from credible sources. If they worked together, it would probably function. This has not been tested.
...
Most wolfkin packs take casual work — short-range contracts, specific guard obligations — and return to their territory between jobs. The Bone Pack has been out three years. Their original denning-ground in the Stillwood's western margin was occupied while they were on a contract, by a settlement elder who had a scribe register it under settlement land law. The pack returned to find their territory on a deed. They have been between work and home since, moving through contracts and building toward a specific resolution that Sura will not name explicitly and that everyone in the pack understands without it being named.
...
Six days into an escort contract — carrying a merchant's goods through a contested hex toward a large village to the east. The trade route collapsed in one section by a washed-out track; the company is moving around it and running behind schedule. The merchant is aware and is attempting to renegotiate the delivery terms. Durn has not agreed to renegotiate.
...
**Ironback Company** — friendly, functional. The Oslunds and the Ironback Company have shared a camp road twice. Durn approves of a formation that doesn't drink on the march. Seld considers the Oslunds reliable in a way that is infrequent enough to be worth noting.
...
| Saltmarch Rovers | —                             | —                           | Ironback (by sight)                                        |
...
| Ironback Company | Salt Brothers (friendly)      | Three Wolves (professional) | Saltmarch (trade), Cold Company (mutual respect)           |
| Cold Company     | —                             | Bone Pack (3 skirmishes)    | Ironback (mutual respect), Three Wolves (same contracts)   |
| Bone Pack        | Mourning Company (blood oath) | Cold Company                | —                                                          |
| Salt Brothers    | Ironback Company              | —                           | —                                                          |
...
| ------------------------------- | --------- | ----------------------- | ------------------------------- | ------------------------------------------------------------------------------- |
| Gruv the One-Armed (orc shaman) | 4 silver  | Pell / Mourning Company | Ashmill, one large village west | Pell's private vendetta; the shaman is currently contracted to the Three Wolves |
| Hadric the Younger              | 15 silver | Merchant factor         | Town 4 hexes east               | Regional spread; known to bounty hunters in the area                            |
...
| Yona / Ironback Company         | 9 silver  | Unknown party           | Settlement 4 hexes NE           | Cold one year old; still technically active                                     |
| Cold Company (whole band)       | 12 silver | Village council         | Settlement 2 hexes south        | Posted two months ago; provisions taken under duress                            |
