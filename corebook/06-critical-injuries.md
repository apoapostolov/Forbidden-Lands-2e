...
For some types of damage (for example from fire, acid, electric shocks, or cold), the normal critical injury tables don't apply. If you're Broken by such a non-typical type of damage, use the table Critical Injuries - Burn.

### CONDITIONS

Some conditions, such as *hungry* and *thirsty*, can Break you (below).
...
In the game there are five so-called conditions your PC can suffer: *hungry*, *thirsty*, *sleepy*, *cold*, and *addicted*. These conditions can cause damage and block recovery. Mark conditions in the relevant check boxes on your character sheet.

#### HUNGRY

You must eat a ration of food at least once every day. After a day without food, you become *hungry*. Being *hungry* has several effects:
...
You must drink a ration of water at least once per day. After a day without water, you become *thirsty*. Being *thirsty* has several effects:
...
When the cold is bitter and you don't have enough shelter, you have to roll *endurance* regularly. The colder it is, the more frequently you need to roll per day; in the depth of winter, you might have to roll once every hour. Extra protection, like a blanket, can give you Gear Dice to roll. If you fail your roll, you become COLD. Being COLD has several effects:

- You immediately take one point of damage to your Strength as the chill stiffens your body and slows your blood.
- You must keep rolling ENDURANCE at the same interval. If you fail, you must reduce either Strength or Wits by one. If your Strength is Broken while you are *COLD*, you die the next time you have to roll.
...
- Roll *INSIGHT* each day you fail to get the substance. On a failure, you take another 1 **Empathy** damage. On a success, you may instead pay 1 WP to remove the ADDICTED condition.
...
Adventurers in the Forbidden Lands are assumed to know how to swim. If you end up in water, you need to make an *ENDURANCE* roll every turn (15 minutes) to stay afloat. If you sink, you need to make an *ENDURANCE* roll every round to hold your breath. If you fail, you start to drown and suffer one point of damage to Strength every round until someone saves you. If you are Broken when drowning, you die after D6 minutes.

### FALLING

If you fall and hit a hard surface, you take 0.5 damage per fallen meter, rounded up. You can reduce the damage by rolling *MOVE* and subtracting the number of ⚔️ rolled. You can reduce the damage by 1 more if you spend a FAST action to controllably jump down. You may take a -2 penalty on the *MOVE* roll to try to land standing, but this only succeeds if you avoid a critical injury. Metal armor gives no protection from falls, unless you also take damage from landing on something sharp, like a trap filled with spears.
...
| --- | ----------------- | ------ | ---------- | ----------------------------------------------------------------------------- | ------------ |
| 11  | Stunned           | No     | —          | None                                                                          | —            |
| 12  | Breathless        | No     | —          | None                                                                          | —            |
| 13  | Rattled skull     | No     | —          | -2 to SCOUTING.                                                               | D6           |
| 14  | Smashed nose      | No     | —          | -1 to MANIPULATION.                                                           | D6           |
| 15  | Smashed fingers   | No     | —          | Two-handed weapons can’t be used.                                             | D6           |
| 16  | Smashed toes      | No     | —          | To RUN becomes a slow action.                                                 | D6           |
| 17  | Knocked out teeth | No     | —          | -1 to MANIPULATION.                                                           | D6           |
| 18  | Groin hit         | No     | —          | 1 point of damage suffered at every MOVE or MELEE roll.                       | D6           |
| 19  | Bruised ribs      | No     | —          | -2 to MOVE and MELEE.                                                         | 2D6          |
| 20  | Wrenched arm      | No     | —          | Two-handed weapons can’t be used.                                             | 2D6          |
| 21  | Wrenched leg      | No     | —          | To RUN becomes a slow action.                                                 | 2D6          |
| 22  | Black eye         | No     | —          | -2 to MARKSMANSHIP and SCOUTING.                                              | 2D6          |
| 23  | Crushed foot      | Yes    | D6 days    | To RUN becomes a slow action.                                                 | 3D6          |
| 24  | Crushed elbow     | Yes    | D6 days    | Two-handed weapons can’t be used.                                             | Permanent    |
| 25  | Crushed knee      | Yes    | D6 days    | To RUN becomes a slow action.                                                 | Permanent    |
| 26  | Neck shock        | No     | —          | Paralyzed from the neck down. If not HEALED in time, the effect is permanent. | 3D6          |
| 27  | Crushed skull     | Yes    | —          | Your adventure and your life end here.                                        | —            |
...
| 63    | Neck stab           | Yes    | –1 D6 rounds  | –2 to ENDURANCE                                           | 2D6          |
| 64    | Skewered skull      | Yes    | —             | You die at once.                                          | —            |
| 65–66 | Pierced heart       | Yes    | —             | Your heart beats for the last time.                       | —            |

### CRITICAL INJURIES – BURN

Use this table when you are Broken by fire, acid, electric, or cold attacks. Some cold effects are listed after a slash.
...
| 23    | Pyromania (treat as a horror injury)  | -      | -          | Roll an extra torch or firewood resource die every day, or burn something else up. You may roll *SCOUTING* to ignore this for a day, but if you succeed, you must also pay 1 WP.   | D6             |
...
| 26-31 | Raw burns / Blackened frostbite       | No     | -          | -2 to *MANIPULATION* rolls, unless you try to intimidate your target, then you instead add +2.                                                                                       | D6             |
...
| 36-41 | Fused with armor / Armor shatters     | No     | -          | Your body armor and clothes have melted onto your skin. Spend a Quarter Day and roll *HEALING* to remove them. On a success, the armor is removed but destroyed. It can never be repaired. | Until removed |
...
| 45    | Tight scars                           | No     | -          | -1 to *MOVE* rolls due to deep scarring. If not healed in time, the effect becomes permanent.                                                                                         | D6             |
...
| 55-56 | Weeping blisters / Rotting toe        | Yes    | D6 days    | You fall unconscious for a Quarter Day. Also suffer both Ugly burns and Fluid loss for 2D6 days. Must be amputated; -1 *MOVE* for D6 days.                                            | -              |
...
| 65    | Cooked brain / Frozen brain           | Yes    | -          | Make a helmet save. On a failure you instantly die.                                                                                                                                  | -              |
...
| 21  | Hair loss           | Some of your hair falls out. Gray or white hair tends to stick more. Take 1 **Empathy** damage whenever you wake up from *SLEEP*. If you are already bald, this can instead come from nightmares of the event.                                                                               | D6           |
| 22  | Clutching at scraps | You take 1 **Empathy** damage each time you must leave items behind.                                                                                                                                                                                                                            | 2D6          |
| 23  | Nightmares          | Make an *INSIGHT* roll after every Quarter Day spent *SLEEPING* for it to count as *SLEEP*.                                                                                                                                                                                                     | D6           |
...
| 25  | Day-sleeper         | You can only *SLEEP* during the light part of the day.                                                                                                                                                                                                                                         | 2D6          |
| 26  | Narrow gaze         | You are forced to ignore one ⚔️ when reacting to anyone except the target of your last action. If anyone targets you with an ability that benefits from your attention, you ignore one ⚔️ from this action (such as *HEALING*, *PERFORMANCE*, or a fear attack).                         | 2D6          |
...
| 42  | Under-breath babbling | You automatically fail any *STEALTH* rolls, and you and your party members suffer a -2 penalty to *SCOUTING*.                                                                                                                                                                                | D6           |
...
| 63  | Emotionless         | You do not gain Willpower from pushing yourself and are unaffected by any *PERFORMANCE* rolls.                                                                                                                                                                                                 | 2D6          |
