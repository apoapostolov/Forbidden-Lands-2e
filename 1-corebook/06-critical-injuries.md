...
If your critical injury is listed as _lethal_, someone must make a successful _healing_ roll to save you - otherwise, you die when the time indicated has passed. If you recover attribute points (above) before you die, you can attempt to _heal_ yourself - but the roll gets a -2 penalty. Each person trying to _heal_ you can only roll once.
...
**CARE:** If someone manages to _heal_ you during the process of healing a critical injury, the remaining healing time is reduced by half. Any earlier roll to save your life does not count towards this - a new roll is required to reduce the healing time.
...
Some blows should kill you outright, yet leave you breathing by a thread. When a physical critical injury roll lands on `65`, someone can still drag you back from death, but the harm remains. If someone saves your life in time, roll on the matching permanent injury table instead.

A `66` is still final. That result means the body is destroyed beyond any field rescue.

Luck, skill, and strong healing magic can still turn aside such ruin. `LUCKY` rank `4` changes a permanent injury into one that heals in `5D6` days, or half that time on a successful _HEALING_ roll. `PHYSICIAN` rank `3` can change a permanent injury into a healed result, but only if the first care was given within fifteen minutes of the wound. _MEND WOUNDS_ closes the critical injury at once, but it does not restore a severed limb or erase bodily ruin. _REGENERATION_ remains the surest answer to maiming, within the limits of the spell as written.

### NON-TYPICAL DAMAGE

For some kinds of harm, the common weapon tables do not apply. Fire and lightning use the Burn table. Acid and other corrosive fluids use the Acid / Corrosion table. Freezing injury uses the Cold / Freeze table. If you are Broken while swallowed, pinned in a gullet, or churning in some beast's gut, use the Swallow table.

### WHEN THE ROAD ENDS

Some injuries leave an adventurer scarred, slower, or half-ruined, yet still fit for the road. Others leave them alive, but so broken in body or mind that every march, fight, and camp must bend around the wound. When that happens, the player may let the adventurer step away from danger without shame.

Such a one has not failed. They have survived. They may remain with the company as a trusted follower, watch-keeper, guide, quartermaster, healer's hand, or counselor. They may also be left in a village, hall, temple, or stronghold where they can be kept warm, fed, and properly tended.

If the adventurer stays with the company as a follower or retainer NPC, they gain `1 XP` per session as normal for hirelings and retainers.

### CONDITIONS

Some conditions, such as _hungry_ and _thirsty_, can Break you (below).

The effects of this is specified by each condition. Don't roll for a critical injury in this case.
...
_Poor Tyrgar was hurt before the savage strike by the minotaur, and is now Broken. He rolls 52 on the critical injury table for slash wounds, and thus suffers a bleeding gut. He rolls a D6 and gets a 5, meaning he will die in five hours unless healed before he bleeds out. Nirmena is not around, so Tyrgar rolls another D6 to see how long it will take him to get back on his feet without help. He rolls a 2. After two hours on the cold ground he comes to. He tries to HEAL himself but fails. He now has three hours to find Nirmena or someone else who can HEAL him before he dies from his injuries._

### CONDITIONS

In the game there are five so-called conditions your PC can suffer: _hungry_, _thirsty_, _sleepy_, _cold_, and _addicted_. These conditions can cause damage and block recovery. Mark conditions in the relevant check boxes on your character sheet.

#### HUNGRY

You must eat a ration of food at least once every day. After a day without food, you become _hungry_. Being _hungry_ has several effects:

- You cannot recover Strength in any way, except through magic. You can recover other attributes.
- You suffer one point of damage to Strength per week. If your Strength is Broken while _hungry_, you die after another week without food.
- As soon as you have eaten, you are no longer _hungry_, and you can recover Strength normally.

#### THIRSTY

You must drink a ration of water at least once per day. After a day without water, you become _thirsty_. Being _thirsty_ has several effects:

- You cannot recover any attributes, except through magic. If you are Broken, you need to drink water to get back up again.
- You suffer one point of damage to both Strength and Agility every day. If either of your Strength or Agility are Broken while _thirsty_, you die after another day without water.
- As soon as you drink, you are no longer _thirsty_, and you can recover your attributes normally.

#### SLEEPY

You need to sleep for at least one Quarter Day of each day. After one day without sleep, you become _sleepy_. Being _sleepy_ has several effects:

- You cannot recover Wits, except through magic. If your Wits are Broken while _sleepy_, you must sleep for at least one Quarter Day to get back up again.
...
- As soon as you have slept for at least a Quarter Day, you are no longer _sleepy_, and you can recover Wits normally.

#### COLD

When the cold is bitter and you don't have enough shelter, you have to roll _endurance_ regularly. The colder it is, the more frequently you need to roll per day; in the depth of winter, you might have to roll once every hour. Extra protection, like a blanket, can give you Gear Dice to roll. If you fail your roll, you become COLD. Being COLD has several effects:

- You immediately take one point of damage to your Strength as the chill stiffens your body and slows your blood.
- You must keep rolling ENDURANCE at the same interval. If you fail, you must reduce either Strength or Wits by one. If your Strength is Broken while you are _COLD_, you die the next time you have to roll.
- If the COLD condition makes your Wits Broken and your Strength is two or less, you can hallucinate and act irrationally. Some say that when you are close to freezing to death, you feel a strong burning sensation that can make you tear your clothes off.
- You cannot recover Strength or Wits. You do not recover in camp or in comfortable rest unless the shelter is heated and dry.

#### ADDICTED

If you become addicted to a substance, you feel an urge to use it every day.

- If the substance is available, you use it that day.
- If it is not available, you take 1 **Empathy** damage and cannot recover **Empathy** in any way that day, except through magic.
- Roll _INSIGHT_ each day you fail to get the substance. On a failure, you take another 1 **Empathy** damage. On a success, you may instead pay 1 WP to remove the ADDICTED condition.
- If your **Empathy** Breaks while ADDICTED and the substance is not available, you will go to lengths to get it. If your party will not help you, you abandon them. The GM has the final say on what happens.

### FEAR

Many horrifying beasts lurk in the shadows of the Forbidden Lands. Such creatures, many of which can be found in the bestiary, can perform so-called fear attacks. Fear attacks can also be triggered by magic and other terrifying experiences.

A fear attack is rolled with a number of Base Dice. Each X rolled causes one point of damage to Wits. All fear attacks have _near_ range, unless stated otherwise. Some fear attacks target a single victim, while others affect everyone within range.

### DARKNESS

When you are in complete darkness and lack

Adventurers in the Forbidden Lands are assumed to know how to swim. If you end up in water, you need to make an _ENDURANCE_ roll every turn (15 minutes) to stay afloat. If you sink, you need to make an _ENDURANCE_ roll every round to hold your breath. If you fail, you start to drown and suffer one point of damage to Strength every round until someone saves you. If you are Broken when drowning, you die after D6 minutes.

### FALLING

If you fall and hit a hard surface, you take 0.5 damage per fallen meter, rounded up. You can reduce the damage by rolling _MOVE_ and subtracting the number of ⚔️ rolled. You can reduce the damage by 1 more if you spend a FAST action to controllably jump down. You may take a -2 penalty on the _MOVE_ roll to try to land standing, but this only succeeds if you avoid a critical injury. Metal armor gives no protection from falls, unless you also take damage from landing on something sharp, like a trap filled with spears.
...
Poisons are measured by Potency. A weak poison has Potency 3, a strong poison has Potency 6, and an extremely potent poison can have Potency 9 or even more. If you ingest poison in some manner, roll an opposed roll against the GM - she rolls a number of Base Dice equal to the Potency and you roll for _ENDURANCE_. If the poison wins, you suffer its full effect. If you win the roll, you only suffer the limited effect of the poison. Poison has no effect on monsters.
...
When exposed to a dangerous contagion or infection, you need to roll an opposed roll for **ENDURANCE** against the Virulence rating of the disease. This is called a sickness roll. A typical disease has a Virulence of 3, but there are diseases with much higher ratings. If you fail the roll, you fall sick. Each disease has a primary burden, which is either **Strength** or **Agility**, depending on its nature. Fevers, wasting sickness, and organ rot sap Strength. Aches, joint inflammation, cramps, and nerve palsy sap Agility. Use the disease description or the GM's call.

- The day after the infection the disease breaks, at which time you suffer one point of damage to the disease's attribute.
- You can't recover that attribute while sick, except through magic.
- Make another sickness roll once per day. Each failed roll means you suffer another point of damage to the disease's attribute.
- You recover only after you have succeeded at a number of sickness rolls equal to the disease's Virulence. Track each success separately; they do not need to be consecutive.
- Each failed sickness roll gives a cumulative -1 die to your next sickness roll. This penalty stacks, but your ENDURANCE dice pool can never drop below 1.
- If your Strength is Broken when sick, you die after another day if you don't get well before then. If your Agility is Broken when sick, you are bedridden and helpless; if you fail a sickness roll while bedridden, you die the next day unless you recover first.

#### MEDICAL AID

If you are cared for by someone during your sickness, this person can roll your sickness rolls instead of you. The healer rolls for _healing_ against the Virulence of the disease. While under care from someone trained in **HEALING**, you gain +2 dice on consecutive sickness rolls. Healing potions can give a bonus to the roll. The _NATURE'S CURE_ spell is also very effective against disease.

#### OTHER DISEASES

The sickness effects described above reflect a common but deadly disease. Other diseases may target different attributes, add delirium or coughing fits, or spread faster in damp or crowded conditions.

### RIDING ANIMALS

A loyal horse or other riding animal is an important asset to any adventurer, not just Riders. The animal can carry your gear during your journeys (see Chapter 7), and you can take advantage of being in the saddle during combat. Several types of riding animals are described in the bestiary.

**MOVEMENT:** Riding animals allow you to move faster across the battlefield than if you are on foot. Every animal has a Movement Rate. This determines how many segments the animal can move with a _RUN_ action. Humanoids have Movement Rate 1 and most riding animals have Movement Rate 2.

To be able to use its full Movement Rate, any zones the animal moves through must have the _OPEN_ feature. In other cases, the animal's Movement Rate is 1.

**MOVE:** When you are mounted, and are about to perform an action that usually requires you to roll _MOVE_ (such as moving into a _ROUGH_ zone), roll for _ANIMAL HANDLING_ instead, using the animal's Agility (not your Empathy). Pushing such a roll will not give you Willpower Points.
...
Use this table when you are Broken by fire, lightning, or similar searing force. Acid, corrosion, and freezing injury use their own tables below.
...
| --- | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| 11  | Addiction                      | Become Addicted to the first one of these you have used this day: Narcotics, Potions, Alcohol, or Tobacco. If you have not used them, you get off scot-free.                                                                                                                | -            |
| 12  | Binge eating                   | You consume twice the normal amount of food.                                                                                                                                                                                                                                | D6           |
| 13  | Shaking fit                    | Penalty -1 to all rolls for **Agility**. Negate the effect for a Quarter Day by using Alcohol or Narcotics.                                                                                                                                                                 | D6           |
| 14  | Fear-sick                      | Penalty -1 to all rolls for **Wits**. Negate the effect for a Quarter Day by using Alcohol or Narcotics.                                                                                                                                                                    | D6           |
| 15  | Spirit-drained                 | Penalty -1 to all rolls for **Empathy**. Negate the effect for a Quarter Day by using Alcohol or Narcotics.                                                                                                                                                                 | D6           |
| 16  | Startled out of your skin      | Whenever you are targeted by a fear attack, you drop anything in your hands.                                                                                                                                                                                                | D6           |
| 21  | Hair loss                      | Some of your hair falls out. Gray or white hair tends to stick more. Take 1 **Empathy** damage whenever you wake up from _SLEEP_. If you are already bald, this can instead come from nightmares of the event.                                                              | D6           |
| 22  | Clutching at scraps            | You take 1 **Empathy** damage each time you must leave items behind.                                                                                                                                                                                                        | 2D6          |
| 23  | Nightmares                     | Make an _INSIGHT_ roll after every Quarter Day spent _SLEEPING_ for it to count as _SLEEP_.                                                                                                                                                                                 | D6           |
| 24  | Must-lead temper               | You must lead the way when traveling or go first when exploring. If not, you split from the party to find your own way.                                                                                                                                                     | D6           |
| 25  | Day-sleeper                    | You can only _SLEEP_ during the light part of the day.                                                                                                                                                                                                                      | 2D6          |
| 26  | Narrow gaze                    | You are forced to ignore one ⚔️ when reacting to anyone except the target of your last action. If anyone targets you with an ability that benefits from your attention, you ignore one ⚔️ from this action (such as _HEALING_, _PERFORMANCE_, or a fear attack).            | 2D6          |
| 31  | Vain as a peacock              | You refuse to wear anything on your head.                                                                                                                                                                                                                                   | D6           |
| 32  | Honorable                      | Reduce your Cold-blooded talent by two ranks. If it would go negative, you refuse to perform a coup de grace or attack prone or disarmed targets. If an ally performs a coup de grace (before you can stop it), you take 2 **Empathy** damage.                              | D6           |
| 33  | Battle-cursing                 | You spend all your fast actions taunting your targets while in combat. This occurs even if you are Broken, as long as you are not unconscious.                                                                                                                              | D6           |
| 34  | Shaken confidence              | Whenever you fail a skill roll, mark that skill. It has a -2 penalty until you succeed at using it. Remove any remaining marks when this heals.                                                                                                                             | 2D6          |
| 35  | Death-marked in your own mind  | You believe your time has come. Whenever you take a critical injury, add to the result, up to a maximum of 66. Ignore all ranks of Lucky.                                                                                                                                   | 2D6          |
| 36  | Cannot leave well enough alone | Whenever you spend a whole day without exploring a new hex or entering any conflict (even if just a social one), you lose all your WP.                                                                                                                                      | 3D6          |
| 41  | Post-combat shakes             | You suffer a 2D6 fear attack as soon as an encounter that involved you rolling initiative ends.                                                                                                                                                                             | D6           |
| 42  | Under-breath babbling          | You automatically fail any _STEALTH_ rolls, and you and your party members suffer a -2 penalty to _SCOUTING_.                                                                                                                                                               | D6           |
| 43  | Blood erosion                  | You take 1 **Agility** damage whenever you see a sufficient amount of blood, for example from every Slash or Stab critical injury inflicted in your vicinity.                                                                                                               | 2D6          |
| 44  | Hair-trigger rage              | You take an equal amount of **Empathy** damage whenever you take **Strength** damage. Whenever your **Empathy** goes to zero you keep fighting, but as constantly being taunted and you must push all rolls.                                                                | 2D6          |
| 45  | Blood-grudge                   | You take 1 **Empathy** damage from each attack that inflicts damage upon your allies. Whenever your **Empathy** goes to zero you keep fighting, but as constantly being taunted and you must push all rolls.                                                                | 3D6          |
| 46  | Panic attacks                  | You automatically take 1 **Agility** damage whenever you take **Wits** or **Empathy** damage.                                                                                                                                                                               | 2D6          |
| 51  | Mind-snared                    | You become fascinated by something related to what Broke you. The GM decides what it is. You lose your fast actions whenever it is within your line of sight.                                                                                                               | 4D6          |
| 52  | Lesser phobia                  | You are terrified by something. You suffer one point of damage to **Wits** each turn (5 minutes) within SHORT range of the thing of your phobia. The GM can pick the most suitable result: 1) Darkness 2) Fire 3) Sharp objects 4) Strangers 5) Confined spaces 6) Animals. | 2D6          |
| 53  | Major phobia                   | You experience terror linked to what has broken you. The GM determines what it is. You take one **Wits** damage every round when near the object of your fear.                                                                                                              | 2D6          |
| 54  | Watching shadows               | Each **Wits** and **Empathy** ⚔️ inflicts damage, even if the rolls are not pushed.                                                                                                                                                                                         | 2D6          |
| 55  | Superstitious                  | You refuse to be voluntarily affected by magic or hold on to any magical items. If someone you consider an ally, against your will, uses magic on you, they Break your **Empathy**.                                                                                         | 3D6          |
| 56  | Death-blind boldness           | You are immune to fear attacks, and always roll your full amount of attribute dice even if hurt, but you will no longer PARRY or DODGE attacks.                                                                                                                             | D6           |
| 61  | Amnesia                        | Remove access to the character sheet. The player does not remember any information on it, can use skills, but not talents. Access to talents can be regained if taught by a teacher, this costs no XP. All are returned when the healing ends.                              | D6           |
| 62  | Seizures                       | When an attribute reaches zero, all your attributes are set to zero.                                                                                                                                                                                                        | 2D6          |
| 63  | Emotionless                    | You do not gain Willpower from pushing yourself and are unaffected by any _PERFORMANCE_ rolls.                                                                                                                                                                              | 2D6          |
| 64  | Hollow-hearted                 | Lose 1 WP every Quarter Day.                                                                                                                                                                                                                                                | D6           |
