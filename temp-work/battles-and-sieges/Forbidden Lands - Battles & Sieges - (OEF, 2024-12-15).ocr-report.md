...
- Raw: `temp-work/battles-and-sieges/Forbidden Lands - Battles & Sieges - (OEF, 2024-12-15).clean.md`

## Raw Artifact Counts

- `all_caps_lines`: 0
- `double_blank_runs`: 38
- `dropcap_damage_candidates`: 152
- `html_breaks`: 0
- `markdown_headings`: 115
- `page_number_lines`: 0
- `picture_placeholders`: 0
- `picture_text_markers`: 0
- `pipe_table_lines`: 112
