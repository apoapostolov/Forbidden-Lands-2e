...
- `references/08-gear-and-economy.md` — **Load when** designing gear, inventory, transport, crafting, construction, property, investment, or economy. Supply/scarcity tables, economy models (barter vs cash+capital vs gold/silver), weapon/armor feature grammar, quality tiers, artifact/legendary dice, consumables-as-resource-dice, carry limits, containers, pack animals, wagons/boats, group stores, stockpiles, storage functions, crafting gates, stronghold functions, property Status, town amenities, Capital, loans, salaries, upkeep, payback, and economic validation.
