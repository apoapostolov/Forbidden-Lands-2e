...
- [Method and Boundaries](#method-and-boundaries)
- [The Social Mind of the Ravenlands](#the-social-mind-of-the-ravenlands)
- [Blood Mist Conditioning](#blood-mist-conditioning)
- [The Psychology of Reopening](#the-psychology-of-reopening)
- [Trust, Reputation, and Obligation](#trust-reputation-and-obligation)
- [Religion as an Explanatory System](#religion-as-an-explanatory-system)
- [Human Social Characters](#human-social-characters)
- [Non-Human Time and Identity](#non-human-time-and-identity)
- [Fear, Grief, Shame, and Anger](#fear-grief-shame-and-anger)
- [Trauma after War, Mist, and Demons](#trauma-after-war-mist-and-demons)
- [Coping and Recovery](#coping-and-recovery)
- [Magic, Possession, and Mental Disturbance](#magic-possession-and-mental-disturbance)
- [Rendering Psychology in Play](#rendering-psychology-in-play)
...
- **Shared condition:** a pressure broadly present in the setting, such as the
  memory of night isolation under the Blood Mist.
- **Cultural script:** a recognized way of behaving, such as Alderlander
  restraint or Aslene face-to-face insult.
- **Individual response:** the character's own use or rejection of that script.

The third level keeps culture playable. Two people can share a script and use
it for opposite ends.
...
## The Social Mind of the Ravenlands

### Local Knowledge Feels Safer Than General Knowledge
...
handles ordinary work correctly. The first person's status claims and embodied
...
the local woods and frightened one ridge beyond them. Courage is geographically
specific.

### Nightfall Created a Daily Deadline

Work away from walls was measured backward from darkness. Delay by weather,
injury, lost animals, or another person's need threatened the whole group. This
...
the night. A child may follow them openly while adults deny interest. A priest
may ask where they slept before asking their name.
...
## The Psychology of Reopening

### Possibility and Threat Arrive Together

The land has been open for only five years. People can now seek lost kin,
markets, teachers, spouses, shrines, revenge, and abandoned property. They can
...
Adults formed under the Mist possess routines of bounded life. Those who were
young when it lifted may experience travel as liberation, temptation, or proof
that elders exaggerated danger. Children born after 1160 know the Mist only
through stories and the behavior it left in adults.

Avoid a simple old-versus-young opposition. Some elders want to recover distant
claims. Some young people prefer the certainty of home. The useful distinction
is whether a person's status, skill, faith, or attachment gains or loses value
...
A returning claimant often expects recognition before asking what the place
became. A local household may experience the claim as an attempt to erase ten
generations of labor. The resulting anger is partly material and partly an
injury to identity.

### News Overloads Closed Worlds

People accustomed to slow information now receive incompatible stories from
several directions. Verification cannot keep pace. Rumor offers both knowledge
and a way to manage fear by giving uncertainty a name.

The most persuasive report is not always the most accurate. It may fit an old
grievance, come through a trusted kin link, explain a shortage, or authorize an
action someone already wants. Show rumor as motivated interpretation, not as
random foolishness.

---

## Trust, Reputation, and Obligation
...
correctly under a host's roof. Boasts are credible only when witnesses connect
them to acts.

### Obligation Can Feel Like Affection

Long mutual dependence makes duty and attachment difficult to separate. A
person may care for an elder because of love, custom, fear of judgment, expected
...
devastation and lost homeland. Meromannians remember Wailer's Hold. These
collective memories can guide prudent caution or justify violence against people
who did not commit the original act.

---

## Religion as an Explanatory System

### Religion Classifies Misfortune

Faith explains why danger occurred, who bears responsibility, what repair is
possible, and which authority may act. Rust language interprets impurity through
ore, slag, tempering, disease, and sacrifice. Raven practice interprets life
through care, animal relationship, cultivation, and resistance to corruption.
...
Offerings, purification, burial, prayer, seasonal fire, water rites, and
witnessed oaths give people actions when causes are uncertain. The practical
effect does not require the rite to be false. In this setting, a rite may be
socially organizing, psychologically containing, and magically effective at the
same time.

Ritual can also shift responsibility. A failed harvest blamed on insufficient
sacrifice protects a ruler who mismanaged stores. A successful healing credited
only to a god may conceal the competence of the healer. Ask who gains authority
from the explanation.

### The Gods Organize Character Ideals

Huge values work, skill, and duty beyond one life. Clay values making and the
continuance of life. Wail and Flow connect dependence to uncontrollable natural
systems. Horn joins destructive force to later fertility. Eor makes concealment,
division, and double identity cosmological. Nightwalker marks the boundary where
ordinary control fails.

People use these divine models to narrate themselves. A dwarf may endure pain
as a damaged tool still fit for work. An Aslene may understand loss as Horn's
burning before renewal. A halfling may treat shame as Eor's divided face. These
frames can sustain recovery or trap a person inside an impossible ideal.

---

## Human Social Characters
...
Ailander social training favors explanation, food before business, communal
deliberation, and speakers whose legitimacy depends on continued consent. This
can create strong belonging and broad participation. It can also make urgent
decision difficult and turn silence or withdrawal into punishment that nobody
admits administering.

An Ailander grievance may appear as reduced cooperation, delayed agreement, or
a story whose moral is obvious to everyone but the outsider. Direct command can
provoke resistance even when the commanded act is accepted as necessary.

### Aslene Directness, Gift, and Honor

Aslene social training favors face-to-face truth, competence with horses,
serious performance, gift reciprocity, and witnessed loyalty. Direct insult can
be less hostile than secret criticism because it gives the other person a
chance to answer.
...
portable. Galdane songs, Meromannian memory, hidden Raven rites, and Alderlander
heraldry preserve a group after land and institutions are lost. The preserved
custom may become stricter abroad than it was at home.

---

## Non-Human Time and Identity
...
Orc rank systems should be read beside the kin's history of servitude and
military betrayal. Dominance, duel, refusal to show fear, and contempt for
surrender can function as defenses against renewed subordination. They also
reproduce slavery inside orc society.

Male public hierarchy and concealed female governance produce different social
performances for insiders and outsiders. A male may defend status violently
while knowing decisions originate elsewhere. A Viraga may cultivate invisibility
because visible rule would disrupt the system through which she acts.

### Halflings and Goblins: Divided Identity

The shared cradle makes each visible community dependent on the one it publicly
rejects. Halfling cheerfulness and concealment protect respectability but create
...
### Fear Is Managed through Task

People admit danger more readily than fear. They check straps, sharpen tools,
...
Grief is expressed through washing, burial, song, inheritance, feeding
dependents, settling debts, speaking with restless dead, and maintaining the
deceased person's place in memory. These duties give form to loss. Failure to
perform them produces shame, haunting, dispute, or literal undead danger.

Continuing contact with walkers complicates mourning. A dead person may still
speak without being capable of consent, judgment, or coherent memory. The
living must decide when care becomes danger and when hope prevents burial from
ending.
...
Ailander action without consent, Aslene insult unanswered, dwarven incompetence,
orc surrender, and halfling exposure are distinct cultural scripts. An outsider
can injure someone without understanding which relation was threatened.

### Anger Defends Boundaries and Masks Injury

Anger mobilizes others and can restore a damaged social position. It also masks
fear, grief, humiliation, and helplessness. A person's target may be the safest
available target rather than the cause.

Ask what the anger is trying to make happen: payment, distance, witness,
submission, restored rank, renewed control, or permission for violence. This
question produces more credible behavior than treating wrath as a free-floating
temperament.

---

## Trauma after War, Mist, and Demons

### Ravenlands Sources of Damage

Use the universal patterns in the generic trauma reference, then add the
setting's distinctive injuries:

- surviving a purge in which religion named the victim impure
- being unable to reach a loved one before nightfall under the Mist
- watching familiar bodies altered by demonic melding
- living beside a restless dead relative who cannot understand death
- returning after years to find a home claimed, occupied, or erased
- learning that a protective authority created or exploited the danger
...
A person who lost someone to the Mist often lacks a body, witness, or final
account. The missing person could be dead, transformed, sheltered elsewhere, or
present as fragmented remains. Uncertainty prevents ordinary burial and
inheritance.

Families respond by preserving a place, declaring death, seeking signs,
accusing a companion, or refusing to speak the name. When the roads reopen,
every rumor can reopen the loss.

### Demonic Alteration and Identity

Misgrowth and melding create a direct question: is the altered person still the
same social person? Different institutions answer according to interest and
theology. Kin may preserve identity through memory and obligation. Rust
authorities may call alteration sanctification. Enemies may call it proof that
all prior bonds are void.

The altered person may experience estrangement from body, appetite, voice, or
other people's gaze. Avoid assuming monstrous appearance eliminates ordinary
attachment. Horror is stronger when familiar habits remain inside changed form.

### Moral Injury under Coercion

Isolation made compromise common. A villager may have informed, surrendered a
traveler, paid a human tithe, denied shelter, abandoned an elder, or served the
Rust Brothers to keep others alive. After the Mist, new witnesses and moral
authorities judge acts performed under closed conditions.
...
### Ordinary Work Re-establishes Sequence

Feeding animals, repairing a roof, grinding grain, tending a fire, preparing a
...
People recover better when someone knows what changed and continues ordinary
contact without demanding an account. Food placed nearby, shared maintenance,
...
Songs, genealogies, religious accounts, and fire stories convert event into
sequence. They decide where the danger began, who acted, what was lost, and what
can be done. A story that preserves competence and acknowledges loss can help a
survivor rejoin the group.

Stories can also falsify. Heroic narration may erase terror. Martyrdom may
erase coercion. A household may prefer a noble death to the survivor's actual
memory. The gap between public account and private behavior is a strong source
of authentic characterization.

### Ritual Creates an End Point

Burial, purification, compensation, oath release, seasonal remembrance, and
the return of an object can mark that a condition has changed. The ritual works
socially when recognized by the people whose behavior must change.

An unrecognized rite may still help the individual but will not restore credit,
inheritance, or belonging. Recovery and reconciliation are related but not
identical.

### New Bonds Are Necessary and Dangerous

Reopened travel permits new fellowships, teachers, partners, patrons, and homes.
For someone injured by loss or betrayal, accepting dependence again is both the
path toward recovery and a renewed risk.

Show this through practical thresholds: sharing watch, lending a tool, sleeping
without armor, naming a route home, allowing someone to carry the key, or
accepting a gift whose return cannot be immediate.
...
Credible communities test explanations through observation:

- Does the condition follow fever, injury, hunger, drink, a spell, or a place?
- Does the person know information they could not possess?
- Do symptoms change around a symbol, ingredient, caster, or boundary?
...
Cultures built on oath and responsibility struggle with acts committed under
...
## Rendering Psychology in Play

### Show the Changed Baseline

Psychological characterization becomes credible through contrast. Establish an
ordinary behavior, then alter it:

- the person who always eats first leaves food untouched
- the gatekeeper who jokes asks the same route question three times
- the Aslene singer refuses a requested verse
- the dwarf stops correcting poor workmanship
- the Ailander speaks a conclusion without the story that normally surrounds it
- the halfling invites strangers into the private house instead of the tavern

The change tells the reader more than a diagnostic label.

### Use Social Interpretation

Different observers explain the same behavior according to relationship and
interest. A captain sees unreliability. A spouse sees exhaustion. A Rust Brother
sees impurity. A Raven Sister sees a wounded life. A rival sees opportunity.

None must be the author's final voice. Let action, evidence, and consequence
distinguish them.
...
alliance, obedience that serves a failed authority, vigilance that prevents
rest, pride that refuses compensation, or local knowledge that cannot travel.

### Questions for AI and GM Use

Before assigning a reaction, answer:

1. What repeated danger or institution taught this behavior?
2. What does the person think the behavior protects?
3. Who rewards it, and who pays for it?
4. Is it a shared cultural script or this person's private adaptation?
5. What visible change would show strain or recovery?
6. Could magic, bodily illness, social interest, and grief offer competing
   explanations?
...
- Preserve the distinction between shared condition, cultural script, and
  individual response.
- Add observed behavior, causal explanation, and setting-specific knowledge;
  never replace existing prose with clinical shorthand or generic templates.
- Check new material against Book 02 History, Gods, and Kin and against the
  generic psychological trauma reference.
-->
