...
**Terrain:** Northern mountains; occasionally Ashlands
**Threat:** High; very high if fully grown

Ice demons. Appear as vaguely humanoid ice formations that
grow larger over time. At Strength 14 they are approximately
two meters tall. At Strength 14, they split into two Fraeges
of Strength 7 each.

**Combat trait:** Cold aura — creatures within Arm's Length
suffer minor cold damage each round. Physical weapons deal
normal damage. Fire and heat spells deal +2 damage and stop
splitting for one round.

**Ecology:** Fraeges are demons but they do not appear to
serve a specific demonic agenda. They wander northern
territories and eat warm things. They are attracted to
fires at night. Setting a large fire in northern mountains
is a risk.
...
**Terrain:** Crimson Forest; occasionally Ashlands edges
**Threat:** Moderate; high if multiple

Plant-insect hybrid. A central root system produces a large
flower on a thick stalk. Multiple fern-like tentacles extend
from the base — approximately ten, each three to four
meters long. They drag prey toward the flower cup, which
contains acid strong enough to dissolve bone in hours.

**Combat trait:** Tentacle grapple — a creature that fails
its MIGHT roll against a tentacle strike is pulled toward
the flower at the end of each round until freed. Cutting
the tentacle frees the target but the tentacle regrows over
a day. The flower cup acid deals ongoing damage per round
for any creature in contact.

**Ecology:** Passive unless approached within range. The
tentacles are sensitive to vibration; heavy footsteps attract
attention from a significant distance in Crimson Forests.
...
**Threat:** High to extreme depending on age

Serpentine creatures of volcanic heat. Acetone smell — strong
enough to detect from fifty meters. Young ktones are called
"ktons." Fully grown fire wyrms are rare and very large.

**Erinya:** The legendary fire wyrm. Old enough that local
traditions treat her as a fixed feature of the landscape.
She lives in the Firelands near Horn. The Arrows of the
Fire Wyrm Astra are associated with her; some traditions
say Sella bargained with Erinya for them.

**Combat trait:** Heat aura — creatures within Short range
suffer ongoing heat damage each round in melee. Bite attack
deals fire damage in addition to physical. At full size a
fire wyrm can swallow human-sized creatures whole.

**Products:** Fire wyrm scales are valuable. Fire wyrm bile
is a fire accelerant. Kton oil from young specimens is
used in lamps that burn hotter than ordinary fuel.
...
**Terrain:** Crimson Forest fungal zones
**Threat:** Moderate; serious in enclosed spaces

A fungal organism that has grown a rough bipedal shape over
a skeleton — human or animal. Bioluminescent sacs of
spores on the back and shoulders. When threatened it
releases the spores as a cloud.

**Combat trait:** Spore cloud within Arm's Length area
causes nausea and disorientation. ENDURANCE roll or the
target suffers Wits damage and loses their next action.
In enclosed spaces the spores accumulate — multiple rounds
of exposure increase the roll difficulty.
...
**Appearance:** Roughly cat-sized, flat-bodied, pale yellow-brown,
with six jointed amber antennae on the dorsal surface.
The antennae vibrate constantly at a frequency that
produces a low collective ticking. In clearings where
multiple hoverfrogs hunt, the sound resolves at distance
into a single soft drone. The frogs drift at three to five
meters height, slow and patient, waiting for birds.
...
**Encounter context:** A victim who wakes from a mara
attack typically cannot describe it coherently. The body
shows bruising on the chest and shoulders. Victims who
have been ridden multiple nights begin refusing to sleep,
then begin sleeping against walls or in confined spaces
out of instinct. Oneiromancers who sleep in a mara's
territory often attract them deliberately — each tradition
has its own method of making the dream-body strong enough
to force the mara off.
